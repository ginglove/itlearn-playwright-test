...
test("TC_EXAM_001", async ({ page }) => {
    ...
    await page.locator('//input[@class = "premium-input"]').first().fill("QUYNHDTA Bài Kiểm Tra Playwright 15 Phút");
    ...
    await expect(page.getByRole("heading", { name: "QUYNHDTA Bài Kiểm Tra Playwright 15 Phút" })).toBeVisible();
